...
脑子里有方案，也知道自己的点在哪——但真要坐下来挖专利点、查新、画框图、排 Word、反复迭代……光想想就已经累了。本技能把这些全包了：你只管给个方向或项目材料，从专利点挖掘到交底书成稿，一条龙打通。覆盖发明/实用新型/外观设计，结构图与外观图都能读懂、写进交底，查新、脱敏、成文、迭代另存——**想得到就能交得出去**。
...
| Node.js 兼容 | ⚠️ 仅 mermaid-cli ^11.4.0 | ✅ mermaid-cli ^11.12.0（Node 18–24 全兼容） |
| 辅助线稿 | ❌ | ✅ 外观轮廓+实用序号引出 |
| CAD/STEP | ❌ | ✅ 多视角 PNG 提取 |
| 审查答复 | ❌ | ✅ 向量 RAG 案例库 |
| 政策嗅探 | ❌ | ✅ 联网出清单，人审后才改技能 |
